...
function App() {
  ...
  let random = [
    ...
    {
      id: 7,
      description: 'Sé mi valentín.',
      img: 'https://i.pinimg.com/originals/db/aa/c1/dbaac13f6278b91a15e480752b8a7242.gif',
    },
    {
      id: 8,
      description: 'Confía en mi, amor.',
      img: 'https://media.tenor.com/cbEccaK9QxMAAAAi/peach-goma.gif',
    },
    {
      id: 9,
      description: 'Confía en miiiiii.',
      img: 'https://i.pinimg.com/originals/db/aa/c1/dbaac13f6278b91a15e480752b8a7242.gif',
    },
    {
      id: 10,
      description: 'Si me dices que no, me quedo sin rodilla.',
      ...
      {!valueSi ? (
        ...
        <div className="flex justify-center items-center flex-col space-y-10">
          <h1 className="text-4xl font-bold">
            Ya sabía yo que ibas a aceptar a la primera :p ❤️!
          </h1>
          <img
